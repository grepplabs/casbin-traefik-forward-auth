...
| `service.admin.type`                         | string | `ClusterIP`                                                                                   | Service type for the admin endpoint.                                                                                                                                |
| `service.admin.port`                         | int    | `8081`                                                                                        | Service port for the admin endpoint.                                                                                                                                |
...
| `application.server.port`                    | int    | `8080`                                                                                        | Port on which the main application server listens.                                                                                                                  |
| `application.server.adminPort`               | int    | `8081`                                                                                        | Port on which the admin server listens.                                                                                                                             |
